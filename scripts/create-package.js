...
(async () => {
	...
	const manifest = {
		...
		scripts: {
			test: 'node --test --experimental-test-module-mocks --experimental-test-coverage --test-coverage-include=lib/**/* --test-coverage-branches=100 --test-coverage-functions=100 --test-coverage-lines=100 **/*.spec.js'
		},
