...
# Migration guide for @dotcom-reliability-kit/middleware-allow-request-methods

This document outlines how to migrate to the latest version of the Reliability Kit middleware-allow-request-methods package. Throughout this guide we use the following emoji and labels to indicate the level of change required:
